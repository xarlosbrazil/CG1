# Fundamentos de Computação Gráfica 2024/1

Alguns projetos de exemploz desenvolvidos para as aulas de Fundamentos de Computação Gráfica do curso Jogos Digitais da Unisinos.
...
## Projetos:
1) Hello Triangle - código base mostrando um código mínimo para o desenho de um triângulo com OpenGL moderna
