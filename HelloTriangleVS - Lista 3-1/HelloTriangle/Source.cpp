...
//#endif
	...
	sprite1.inicializar(glm::vec3(400.0, 300.0, 0.0), glm::vec3(100.0, 100.0, 1.0));
	sprite1.setShader(&shader);

	sprite2.inicializar(glm::vec3(100.0, 300.0, 0.0), glm::vec3(50.0, 50.0, 1.0));
	sprite2.setShader(&shader);

	sprite3.inicializar(glm::vec3(600.0, 300.0, 0.0), glm::vec3(50.0, 100.0, 1.0));
