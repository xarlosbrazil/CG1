...
//#endif
	...
	// Loop da aplica��o - "game loop" // -------------- EXERCICIO 5 ESTA TODO COMENTANDO OU ALTERANDO OS ARGUMENTOS CONFORME APONTADO. NO MOMENTO ESTA TUDO ATIVO (5d) --------------
	while (!glfwWindowShouldClose(window))
	{
		...
		glLineWidth(10);
		glPointSize(10); // -------------- EXERCICIO 5a E 5b: VALOR ZERADO PARA REMOVER OS PONTOS, PREENCHIDO E APENAS CONTORNO --------------
		...
		glDrawArrays(GL_TRIANGLES, 0, 6); // -------------- EXERCICIO 5b e 5c: COMENTAR ESTA LINHA DE CODIGO PARA REMOVER O PREENCHIMENTO (5c), + ZERAR glPointSize (5b), E  --------------

		// Contorno do polígono - GL_LINE_LOOP
		glUniform4f(colorLoc, 1.0f, 1.0f, 0.0f, 1.0f);
		glDrawArrays(GL_LINE_LOOP, 0, 3); // -------------- EXERCICIO 5a E 5c: COMENTAR glDrawArrays (ambos) para remover contorno  --------------
